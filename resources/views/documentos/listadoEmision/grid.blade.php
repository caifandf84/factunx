...
<script>
    $(document).ready(function () {
        jQuery("#grid-documentos").jqGrid({
            ...
            datatype: "json",
            height: 300,
            colNames: ['Id','Seleccion','Uuid', 'idTipoDoc', 'Documento', 'Serie', 'Número', 'Fecha', 'RFC Emisor', 'Nombre Emisor',
                        'RFC Receptor', 'Nombre Receptor','Moneda', 'Monto','Estatus','PDF','XML','Enviar'],
            colModel: [
                {name: 'id', index: 'id', width: 60},
                {name: 'sel', index: 'sel', width: 50,hidden:true},
                {name: 'uuid', index: 'uuid', width: 50,hidden:true},
                ...
                {name: 'rfcReceptor', index: 'rfcReceptor', width: 120},
