...
<div class="container" >
    ...
    <div class="row">
        <div class="panel panel-primary">
            <div class="panel-heading">Documentos para Cancelar ante el SAT</div>
            <div class="panel-body">
                ...
                <div class="row"> 
                    @include('documentos.cancelar.grid')
                </div>
            </div>
        </div>
    </div>   
...
<script type="text/javascript" >
    ...
    function buscarDocumento() {
        ...
        var url = "{{ url('/documentos/cancelacion/listado') }}?rfc_cliente=" + rfcCliente + "&nombre_cliente=" +
